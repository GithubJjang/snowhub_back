package com.example.AuthwithFirebase.FirebaseSpringboot.dummy.dummy;

import com.example.AuthwithFirebase.FirebaseSpringboot.dummy.config.SingleRestTemplate;
import com.example.AuthwithFirebase.FirebaseSpringboot.dummy.config.SupplierConfig.GoogleConfig;
import com.example.AuthwithFirebase.FirebaseSpringboot.dummy.model.User;
import com.example.AuthwithFirebase.FirebaseSpringboot.dummy.service.security.CustomUserDetailsService;
...
public class Google {
    ...
    // 3. 환경설정 초기화
    public void setEnviromentConfig(GoogleConfig GoogleConfig){
